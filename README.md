...
BezierMove is the mootools library which can help you to move any element along the bezier cure.
Another possibility is to move the element on any other curve (circle, ellipse, sinusode, etc.) but it must be defined by equation
